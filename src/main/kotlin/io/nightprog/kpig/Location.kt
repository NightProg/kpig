 ...
 *
 * The `io.nightprog.kpig.Location` class provides details about where a parsed element is located within the input source,
...
data class Location(val range: IntRange, val lexeme: String, val source: Source) {
     ...
     *
     * This function uses the current line number (based on the `io.nightprog.kpig.Source` object) to fetch the corresponding
